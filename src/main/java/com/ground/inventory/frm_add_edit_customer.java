...
public class frm_add_edit_customer extends JDialog implements ActionListener {
	...
	boolean ADDING_STATE;
        ...
        /**
         * Form for add and edit Customer.
         * @param ADD_STATE
         *            <code>true</code> if Add new Customer. <code>false</code>
         *            Update Customer.
         * @param OwnerForm
         * @param srcCN
         * @param srcSQL
				...
				if(ADDING_STATE == true){
					try{
						...
						stAEC.executeUpdate("INSERT INTO tblCustomer(CustomerID,CompanyName,ContactName,ContactTitle,Address,CityTown,StateProvince,ZipCode,Country,Phone,Fax) " +
	   							   	        "VALUES ('" + JTFId.getText() + "', '" + JTFName.getText() + "', '" + JTFContName.getText() + "', '" + JTFContTitle.getText() + "', '" + JTFAddr.getText() + "', '" + JTFCity.getText() + "', '" + JTFState.getText() + "', '" + JTFZipCode.getText() + "', '" + JCBCountry.getSelectedItem().toString() + "', '" + JTFPhone.getText() + "', '" + JTFFax.getText() + "')");
					...
					try{
						...
						stAEC.executeUpdate("UPDATE tblCustomer SET CustomerID = '" + JTFId.getText() + "', CompanyName = '" + JTFName.getText() + "', ContactName = '" + JTFContName.getText() + "', ContactTitle = '" + JTFContTitle.getText() + "', Address = '" + JTFAddr.getText() + "', CityTown = '" + JTFCity.getText() + "', StateProvince = '" + JTFState.getText() + "', ZipCode = '" + JTFZipCode.getText() + "', Country = '" + JCBCountry.getSelectedItem().toString() + "', Phone = '" + JTFPhone.getText() + "', Fax = '" + JTFFax.getText() + "' WHERE CustomerIndex = " + RowIndex);
